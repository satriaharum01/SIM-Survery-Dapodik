            ...
            <table class="table table-bordered" id="datawidth" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th width="10%" style="text-align:center; vertical-align: middle;">Kode</th>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a class="btn btn-danger btn-hapus" data-id="' + data + '" data-handler="section" href="<?= url('admin/sekolah/delete') ?>/' + data + '">\
                        <i class="fa fa-trash"></i> Hapus</a> \
					    <form id="delete-form-' + data + '-section" action="<?= url('admin/section/delete') ?>/' + data + '" \
